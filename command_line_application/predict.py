...
ap.add_argument('input_img', default='/content/drive/MyDrive/aipnd-project-master/flower_data/test/10/image_07090.jpg')
ap.add_argument('checkpoint', default='/content/drive/MyDrive/aipnd-project-master/checkpoint.pth')
ap.add_argument('--top_k', default=5, dest="top_k", action="store", type=int)
ap.add_argument('--category_names', dest="category_names", action="store", default='/content/drive/MyDrive/aipnd-project-master/cat_to_name.json')
